...
export default {
  ...
  methods: {
    async fetchData() {
      ...
      if(this.activeNodes && this.activeNodes[0] && !this.items.find(item => this.activeNodes[0] === item[this.idKey])) {
        this.activeNodes = [0]
      }
      this.loading = false
    },
